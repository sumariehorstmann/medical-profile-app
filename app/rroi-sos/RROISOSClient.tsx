...
export default function RROISOSClient({
  ...
  const [processingContact, setProcessingContact] = useState<
    1 | 2 | null
  >(null);

  const [sosMessage, setSOSMessage] = useState("");

  async function handleSOS(contactNumber: 1 | 2) {
    ...
    setProcessingContact(contactNumber);
...
If you log out, you'll need to sign in again before you can use RROI SOS.
  ...
  const contact1Configured = Boolean(
    settings.contact_1_phone
  );

  const contact2Configured = Boolean(
