...
try {
  ...
  card_qty: 1,
  items: [
  { name: "Engraved Metal QR Card", quantity: 1 },
  { name: "Engraved Metal QR Tag", quantity: 1 },
  { name: "Pack of 5 Splash-Proof QR Stickers", quantity: 1 },
  { name: "RROI Premium Emergency Profile (1 Year)", quantity: 1 },
  { name: "Free Nationwide Delivery", quantity: 1 },
],
...
items: [
  ...
  {
    name: "RROI Premium Emergency Profile (1 Year)",
    quantity: 1,
    unit_price: 0,
    total: 0,
  },
  {
    name: "Free Nationwide Delivery",
    quantity: 1,
    unit_price: 0,
    total: 0,
  },
